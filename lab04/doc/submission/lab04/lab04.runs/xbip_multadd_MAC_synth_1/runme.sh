...
HD_PWD='C:/Users/lucetre/Documents/semester/lab04/lab04.runs/xbip_multadd_MAC_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xbip_multadd_MAC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xbip_multadd_MAC.tcl
