...
HD_PWD='C:/Users/DAUN/lab4/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_array.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_array.tcl -notrace
