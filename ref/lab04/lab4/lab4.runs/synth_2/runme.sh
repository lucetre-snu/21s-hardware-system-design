...
HD_PWD='C:/Users/DAUN/lab4/lab4.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log adder_array.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_array.tcl
