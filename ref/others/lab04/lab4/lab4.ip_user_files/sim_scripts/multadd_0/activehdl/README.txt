...
#
# Generated by export_simulation on Sun Apr 05 19:14:00 +0900 2020
#
################################################################################
...
'-reset_run' switch to the './multadd_0.sh' script.

./multadd_0.sh -reset_run
...
./multadd_0.sh -noclean_files

For more information on the script, please type './multadd_0.sh -help'.
