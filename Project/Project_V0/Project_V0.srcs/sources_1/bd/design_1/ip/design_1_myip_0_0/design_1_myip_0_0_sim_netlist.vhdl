...
-- Date        : Thu May 27 14:35:23 2021
-- Host        : lucetre running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/lucetre/Documents/semester/21s-hardware-system-design/Project/Project_V0/Project_V0.srcs/sources_1/bd/design_1/ip/design_1_myip_0_0/design_1_myip_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_myip_0_0_myip_v1_0_S00_AXI is
  ...
  signal bram_wr_addr0 : STD_LOGIC_VECTOR ( 29 downto 0 );
  signal \bram_wr_addr0_carry__0_n_0\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__0_n_1\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__0_n_2\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__0_n_3\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__1_n_0\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__1_n_1\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__1_n_2\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__1_n_3\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__2_n_0\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__2_n_1\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__2_n_2\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__2_n_3\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__3_n_0\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__3_n_1\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__3_n_2\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__3_n_3\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__4_n_0\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__4_n_1\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__4_n_2\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__4_n_3\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__5_n_0\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__5_n_1\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__5_n_2\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__5_n_3\ : STD_LOGIC;
  signal \bram_wr_addr0_carry__6_n_3\ : STD_LOGIC;
  signal bram_wr_addr0_carry_i_1_n_0 : STD_LOGIC;
  signal bram_wr_addr0_carry_i_2_n_0 : STD_LOGIC;
  signal bram_wr_addr0_carry_n_0 : STD_LOGIC;
  signal bram_wr_addr0_carry_n_1 : STD_LOGIC;
  signal bram_wr_addr0_carry_n_2 : STD_LOGIC;
  signal bram_wr_addr0_carry_n_3 : STD_LOGIC;
  ...
  signal \NLW_bram_wr_addr0_carry__6_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_bram_wr_addr0_carry__6_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
...
bram_wr_addr0_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => bram_wr_addr0_carry_n_0,
      CO(2) => bram_wr_addr0_carry_n_1,
      CO(1) => bram_wr_addr0_carry_n_2,
      CO(0) => bram_wr_addr0_carry_n_3,
      CYINIT => '0',
      DI(3) => bram_counter_reg(3),
      DI(2) => '0',
      DI(1) => bram_counter_reg(1),
      DI(0) => '0',
      O(3 downto 0) => bram_wr_addr0(3 downto 0),
      S(3) => bram_wr_addr0_carry_i_1_n_0,
      S(2) => bram_counter_reg(2),
      S(1) => bram_wr_addr0_carry_i_2_n_0,
      S(0) => bram_counter_reg(0)
    );
\bram_wr_addr0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => bram_wr_addr0_carry_n_0,
      CO(3) => \bram_wr_addr0_carry__0_n_0\,
      CO(2) => \bram_wr_addr0_carry__0_n_1\,
      CO(1) => \bram_wr_addr0_carry__0_n_2\,
      CO(0) => \bram_wr_addr0_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => bram_wr_addr0(7 downto 4),
      S(3 downto 0) => bram_counter_reg(7 downto 4)
    );
\bram_wr_addr0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      CI => \bram_wr_addr0_carry__0_n_0\,
      CO(3) => \bram_wr_addr0_carry__1_n_0\,
      CO(2) => \bram_wr_addr0_carry__1_n_1\,
      CO(1) => \bram_wr_addr0_carry__1_n_2\,
      CO(0) => \bram_wr_addr0_carry__1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => bram_wr_addr0(11 downto 8),
      S(3 downto 0) => bram_counter_reg(11 downto 8)
    );
\bram_wr_addr0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      CI => \bram_wr_addr0_carry__1_n_0\,
      CO(3) => \bram_wr_addr0_carry__2_n_0\,
      CO(2) => \bram_wr_addr0_carry__2_n_1\,
      CO(1) => \bram_wr_addr0_carry__2_n_2\,
      CO(0) => \bram_wr_addr0_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => bram_wr_addr0(15 downto 12),
      S(3 downto 0) => bram_counter_reg(15 downto 12)
    );
\bram_wr_addr0_carry__3\: unisim.vcomponents.CARRY4
     port map (
      CI => \bram_wr_addr0_carry__2_n_0\,
      CO(3) => \bram_wr_addr0_carry__3_n_0\,
      CO(2) => \bram_wr_addr0_carry__3_n_1\,
      CO(1) => \bram_wr_addr0_carry__3_n_2\,
      CO(0) => \bram_wr_addr0_carry__3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => bram_wr_addr0(19 downto 16),
      S(3 downto 0) => bram_counter_reg(19 downto 16)
    );
\bram_wr_addr0_carry__4\: unisim.vcomponents.CARRY4
     port map (
      CI => \bram_wr_addr0_carry__3_n_0\,
      CO(3) => \bram_wr_addr0_carry__4_n_0\,
      CO(2) => \bram_wr_addr0_carry__4_n_1\,
      CO(1) => \bram_wr_addr0_carry__4_n_2\,
      CO(0) => \bram_wr_addr0_carry__4_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => bram_wr_addr0(23 downto 20),
      S(3 downto 0) => bram_counter_reg(23 downto 20)
    );
\bram_wr_addr0_carry__5\: unisim.vcomponents.CARRY4
     port map (
      CI => \bram_wr_addr0_carry__4_n_0\,
      CO(3) => \bram_wr_addr0_carry__5_n_0\,
      CO(2) => \bram_wr_addr0_carry__5_n_1\,
      CO(1) => \bram_wr_addr0_carry__5_n_2\,
      CO(0) => \bram_wr_addr0_carry__5_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => bram_wr_addr0(27 downto 24),
      S(3 downto 0) => bram_counter_reg(27 downto 24)
    );
\bram_wr_addr0_carry__6\: unisim.vcomponents.CARRY4
     port map (
      CI => \bram_wr_addr0_carry__5_n_0\,
      CO(3 downto 1) => \NLW_bram_wr_addr0_carry__6_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \bram_wr_addr0_carry__6_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_bram_wr_addr0_carry__6_O_UNCONNECTED\(3 downto 2),
      O(1 downto 0) => bram_wr_addr0(29 downto 28),
      S(3 downto 2) => B"00",
      S(1 downto 0) => bram_counter_reg(29 downto 28)
    );
bram_wr_addr0_carry_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
bram_wr_addr0_carry_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
