...
HD_PWD='C:/Users/lucetre/Documents/semester/21s-hardware-system-design/Project/Project_V0_interim/mm_mul/mm_mul.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mm_multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mm_multiplier.tcl -notrace
