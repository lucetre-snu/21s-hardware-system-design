...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/lucet/semester/21s-hardware-system-design/Project/proj/V1_Quantization/Verilog/Project_V1_Quantization/Project_V1_Quantization.cache/compile_simlib/riviera"
  fi
