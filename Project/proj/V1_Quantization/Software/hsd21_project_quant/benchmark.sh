...
sudo python eval.py --num_test_images 1000 --m_size 64 --v_size 64 --network cnn --run_type cpu
echo -e '\n=> Accuracy should be 1.0\n'

# Quantization - Acc: 1.0
sudo python eval.py --num_test_images 1000 --m_size 64 --v_size 64 --network cnn --run_type cpu --quantized
echo -e '\n=> Accuracy should be 1.0\n'
